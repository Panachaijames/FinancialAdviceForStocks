// Price-alert evaluation — pure functions, shared by the client (in-app watcher)
// and the server (closed-app watcher) so the two can never disagree on when an
// alert fires. Alert kinds:
